...
grep -Fq 'model: gpt-5.4' "${STAGE}/openai.yaml"
grep -Fq 'analysisSeconds: 300' "${STAGE}/openai.yaml"
grep -Fq 'executionSeconds: 300' "${STAGE}/openai.yaml"
grep -Fq 'verificationSeconds: 300' "${STAGE}/openai.yaml"
