...
grep -Fq 'preRunDelay: "10m"' "${STAGE}/config.yaml"
...
grep -Fq 'pollInterval: "45s"' "${STAGE}/install.sh"
grep -Fq 'preRunDelay: "10m"' "${STAGE}/install.sh"
grep -Fq 'postRunDelay: "2h"' "${STAGE}/install.sh"
